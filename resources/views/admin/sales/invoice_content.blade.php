        ...
        @else
            ...
            <div class="invoice-header" style="display: flex; align-items: center; justify-content: space-between; border-bottom: 2px solid #ccc; padding-bottom: 15px;">
                ...
                <div class="invoice-address" style="text-align: left; color: #444;">
                    ...
                    <p style="margin: 0; font-size: 12px; color: #2e3e5c;">0333-2460463</p>
                    <p><strong style="margin: 0; font-size: 15px; color: #2e3e5c;">Manager:</strong> <br> <span style="margin: 0; font-size: 13px; color: #ff8717;">Muhammad Naeem Iqbal</span> </p>
                    <p style="margin: 0; font-size: 12px; color: #2e3e5c;">{{ $business->phone }} <br> 0318-4905315</p>
                </div>
            </div>
        @endif
