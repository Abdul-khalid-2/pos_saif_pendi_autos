        ...
        $(document).ready(function() {
            ...
            const cart = {
                ...
                updateCart: function() {
                    ...
                    $('#cartSubtotal').text('Rs ' + totals.subtotal);
                    $('#cartTax').text('Rs ' + totals.tax);
                    $('#cartTotal').text('Rs ' + totals.total);
                    ...
                    $('#changeDue').text('Rs ' + changeDue);
                    $('#dueBalance').text('Rs ' + dueBalance);
                    $('#formDueBalance').val(dueBalance);
                },
            ...
            function loadAllData() {
                return $.get("{{ route('allPosProducts') }}", function(response) {
                            ...
                            modalBody += `
                                <div class="mb-2 variant-option" 
                                    ...
                                    <div class="d-flex justify-content-between align-items-center p-2 border rounded">
                                        ...
                                        <div>
                                            <div>Rs ${parseFloat(variant.selling_price)}</div>
