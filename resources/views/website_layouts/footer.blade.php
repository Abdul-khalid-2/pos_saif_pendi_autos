    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid md:grid-cols-4 sm:grid-cols-2 gap-8 text-center sm:text-left">
            ...
            <div>
                ...
                <div class="space-x-4 md:flex-row justify-center md:justify-between items-center text-center md:text-left">
                    ...
                    <!-- <a href="https://api.whatsapp.com/send?phone=923184905315"
                        class="text-gray-400 hover:text-white transition-slow"
                        target="_blank"
                        rel="noopener noreferrer"
                        title="Chat with us on WhatsApp">
        ...
        <div class="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
            ...
            <div class="flex space-x-6">
                <p>if you want make you business digitalized contect us : 03340673401</p>
