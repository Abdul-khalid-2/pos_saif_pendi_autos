...
<body class="font-sans bg-gray-50 text-gray-800 transition-colors duration-300">
    ...
    <button id="theme-toggle" 
        class="fixed top-24 right-4 z-50 p-3 rounded-full shadow-lg 
            bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700
            transition-colors duration-300 flex items-center justify-center">
        <!-- Icons -->
        <svg id="icon-sun" xmlns="http://www.w3.org/2000/svg" 
            class="h-6 w-6 text-yellow-500 transition-opacity duration-300 opacity-0 dark:opacity-100" 
            fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
                d="M12 3v1m0 16v1m8.66-12.66l-.7.7M4.05 19.95l-.7.7M21 12h1M2 12H1m16.95 7.95l.7.7M5.05 4.05l.7.7M12 7a5 5 0 100 10 5 5 0 000-10z" />
        </svg>
        <svg id="icon-moon" xmlns="http://www.w3.org/2000/svg" 
            class="h-6 w-6 text-gray-700 transition-opacity duration-300 opacity-100 dark:opacity-0" 
            fill="currentColor" viewBox="0 0 24 24">
            <path fill-rule="evenodd" 
                d="M17.293 14.707a8 8 0 11-11-11 9 9 0 1011 11z" 
                clip-rule="evenodd" />
        </svg>
    </button>
    ...
    <div class="mobile-bottom-nav">
        ...
        class="mobile-nav-item {{ request()->routeIs('all.products') ? 'active' : '' }}">
