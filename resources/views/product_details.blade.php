<x-website-layout>
    ...
    <script>
        ...
        function renderProductDetails() {
            ...
            let images = [];
            try {
                if (productData.image_paths) {
                    images = JSON.parse(productData.image_paths);
            ...
            // Prepend /backend/ to all image paths
            images = images.map(img => window.assetBaseUrl + img);

            // Fallback if no images
            if (images.length === 0) {
                images = [window.noImagePath];
            }

            const imageGallery = images.map(img => `
                <img src="${img}" alt="${productData.name}" class="border rounded-md h-20 w-20 object-cover cursor-pointer hover:border-primary-600"
            ...
            $('#product-container').html(`
                ...
                <div class="lg:w-1/2">
                    <div class="bg-white p-4 rounded-xl shadow-sm">
                        ...
                        <div class="product-gallery flex gap-2 mt-4">
                            ${imageGallery}
                        </div>
                    </div>
                ...
                <div class="lg:w-1/2">
                    ...
                    <div class="border-t pt-4">
                        <div class="flex items-center text-gray-600">
                            ...
                            <div>
                                <p class="font-medium">Delivery fees as per discussion</p>
