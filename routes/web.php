...
use App\Http\Controllers\Website\WebsiteTwoFactorAuthController;
...
Route::group([
    ...
    Route::middleware(['auth', 'verified', 'role:admin|super-admin'])->group(function () {
        ...
        Route::get('/products/{product}/variants_data', [PosController::class, 'variants'])->name('products.variants');
    ...
    Route::get('all-products', [HomeController::class, 'viewAllProducts'])->name('all.products');
    ...
    // 2FA routes
    Route::get('/2fa', [WebsiteTwoFactorAuthController::class, 'show2FAForm'])->name('2fa.show')->middleware('guest');
    Route::post('/2fa/verify', [WebsiteTwoFactorAuthController::class, 'verify2FA'])->name('2fa.verify')->middleware('guest');
    Route::post('/2fa/resend', [WebsiteTwoFactorAuthController::class, 'resend2FA'])->name('2fa.resend')->middleware('guest');
    ...
    Route::post('/admin/messages/{id}/read', [ContactController::class, 'markAsRead'])->name('messages.markAsRead');
    Route::post('/admin/messages/{id}/unread', [ContactController::class, 'markAsUnread'])->name('messages.markAsUnread');
    Route::get('/admin/messages/unread/count', [ContactController::class, 'getUnreadMessages'])->name('messages.unread');
});
